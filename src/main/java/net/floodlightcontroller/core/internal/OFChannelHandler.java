...
//    	sendHandShakeMessage(OFType.HELLO);
    ...
    public void messageReceived(ChannelHandlerContext ctx, MessageEvent e)
        ...
        else if (e.getMessage() instanceof IOFMessageProvider) {
        	log.info("Warp: Incoming provider instance");
    		IOFMessageProvider provider = (IOFMessageProvider)e.getMessage();
//    		sw.setMessageProvider(provider);
    		e.getChannel().write(ChannelBuffers.wrappedBuffer(provider.encodeHelloMessage()));
    		e.getChannel().write(ChannelBuffers.wrappedBuffer(provider.encodeSwitchFeaturesRequest()));
